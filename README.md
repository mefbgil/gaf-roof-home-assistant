...
Transient device-list failures are retried up to three times with exponential
backoff. Authentication failures still fail immediately or start Home
Assistant's reauthentication flow after one automatic token refresh.
